...
agr.table %>%
  ...
  kable(label = "\\label{tab:ac-agr-dots-r-advice-agr}Advisor agreement for Dots task Accuracy vs Agreement experiment")
...
agr.table %>% 
  ...
  kable(label = "\\label{tab:ac-acc-dots-r-advice-acc}Advisor accuracy for Dots task Accuracy vs Agreement experiment")
