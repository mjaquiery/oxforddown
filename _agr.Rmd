...
\mccorrect{NICK: Need to explain what this is. But above in the corresponding Results section it seems like you are talking about influence of overall advice in the familiarisation phase. I had forgotten this detail about test advice trials with offbrand advice. Remind the reader, even if the specifics are already explained in the general methods. In general, your discussion ought to focus first on pick rates. E.g., what do you takeaway from the finding of more picks for agreeing advice in both tasks (without feedback)? Then comment on what happens with feedback -- the bonus for agreeing advice is (overall) lost. But you still see wide preferences: These could be just random picks, but it could also be something systematic -- some people really like agreement, others like disagreement (as a preview of your modelling of advisor choices). Any analysis of influence in this study (and in the series of experiments in general) has to be very tentative, given the designs are not optimised to measure it. I would not put a lot of time into investigating influence differences.}
