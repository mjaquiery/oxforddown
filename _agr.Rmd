...
kable(agr.table, caption = "Advisor advice profiles for Dots task Agreement experiment") %>%
  kable_styling() %>%
...
exclusions %>% 
  ...
  kable(caption = "Participant exclusions for Dots task Agreement experiment") %>%
...
agr.table %>%
  ...
  kable(caption = "Advisor agreement for Dots task Agreement experiment")
...
agr.table %>% 
  ...
  kable(caption = "Advisor accuracy for Dots task Agreement experiment")
