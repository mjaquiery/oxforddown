...
These models share a foundation in a general theory of advice-taking in which people increase or decrease their trust in others consequent on the perceived value of the information they impart. 
...
In some discussions (e.g. debates about whether slave ownership is morally permisable) we can be glad that near-universal opinion reigns on the issue, despite its once being a contested issue.
...
The mathematics and computational results will remain the same, but the real-life implications would change dramatically depending upon the context which the models were chosen to represent. 
