...
exclusions %>% 
  ...
  kable(caption = "Table \\label{tab:ai-ava-dates-exclusions}: Participant exclusions for Dates task advice influence experiment") %>%
...
kable(.BF, caption = "Table \\label{tab:ai-ava-dates-r-bf}: Bayesian ANOVA for Dates task advice influence experiment")

kableANOVA(.AOV$ANOVA, caption = "Table \\label{tab:ai-ava-dates-r-aov}: Frequentist ANOVA for Dates task advice influence experiment")
...
The equivalence of the influence of the advisors in the No feedback condition may be a consequence of relatively high levels of advice influence overall, producing a ceiling effect (with the numerical advantage for the Agreeing advisor, as predicted by the theory).
...
While not wholly consistent with the agreement-as-proxy account, the results were broadly consistent with previous work: participants systematically took more advice from the more accurate advisor. 
The distinction between agreeing and accurate advice revealed by \mccorrect{Niccolo and Nick} generalises to a substantially different task which uses a different kind of decision and different level of exposure to advisors' advice.
