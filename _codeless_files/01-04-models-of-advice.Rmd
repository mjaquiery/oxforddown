...
\mccorrect{!TODO[Maybe discuss dugginsPsychologicallyMotivatedModelOpinion2017]}
...
\mccorrect{NICK: Unpack the goals in a paragraph here, in terms of what you aim/expect to learn: Comparison between the Baseline and Homogeneous model provides a basic proof-of-concept replication of previous work described above: We expect to find XYZ. Comparison between the Homogenous and Hetergeneous model extends this approach to ask XYZ, etc.}
