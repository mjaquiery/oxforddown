...
These prior expectations may be both learned, as where individuals who grow up in less stable environments show lower propensity to trust \mccorrect{!TODO[Find reference]}, and inherited.
...
These are processed using a fitness function that \mccorrect{TODO: Categorical fitness function description}
...
\mccorrect{QUESTION: Wouldn't the lowest score be 1 so the multiplication by 10 would only need to happen once?}
