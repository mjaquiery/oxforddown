...
\mccorrect{While the broader contextual considerations highlighted by our evolutionary simulations affect the conclusions one draws from egocentric discounting relative to the normative model, they do not detract substantially from the practice of using the normative model as an optimum 'set point' from which to evaluate advice-taking behaviour.}

\mccorrect{Group identity processes probably have a lot to do with turning pretty harmless interaction pattern stuff into the famous runaway examples of extremism like Q-Anon etc. But it has been ever thus, cults online are little different to cults offline in that they prey on the vulnerable to offer an insular monoculture where dissent is heresy. (Groupthink)}

\mccorrect{Talk about other decision-making tasks, and the contribution of reasons, e.g. @troucheArgumentsMoreConfidence2014a}
