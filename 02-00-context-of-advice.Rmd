...
@hutterSeekingAdviceSampling2016 found consistently higher influence for advice that was further from the initial estimate both for single pieces of advice and for integrating multiple pieces of advice.
...
The argument that close advice leads people to update their confidence rather than their judgement may offer an explanation of the more straightforward monotonic reduction in advice-taking with distance.
This interpretation would be consistent with the results of @yanivUsingAdviceMultiple2007 if we assume that this confidence reduces advice influence ([§Task properties](#coa-ed-task)) and this reduction of influence disproportionately affects distant advice.
...
@ginoEffectsTaskDifficulty2007 found that participants opt to receive advice on almost all trials, including in the easy condition, but found no differences in the extent to which advice was used between the compulsory and optional advice experiments.
...
In the real world, price is often an indicator of quality, albeit an imperfect one, and solicitation is likely to act as a proxy for confidence, which is again related to task difficulty: participants in the experiments may have taken more advice because they were less sure on the trials in which they sought advice.
