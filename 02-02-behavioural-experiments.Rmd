...
m <- tmp %>%
  ...
  lmer(advisor0Influence ~ Distance * Rating + (1|pid), data = .)
...
\begin{align}
    \text{Influence}_t^a = \\
    & \hspace{-4em} \beta 0 +  \\
    & \hspace{-4em} \beta 1 *\text{Distance}_t^a + \\
    & \hspace{-4em} \beta 2 *(\text{Rating}_t^a=\text{Possibly Deceptive}) + \\
    & \hspace{-4em} \beta 3 *(\text{Rating}_t^a=\text{Deceptive}) + \\
    & \hspace{-4em} \beta 4 *(\text{Rating}_t^a=\text{Possibly Deceptive}) * \text{Distance}_t^a + \\
    & \hspace{-4em} \beta 5 *(\text{Rating}_t^a=\text{Deceptive}) * \text{Distance}_t^a \\
    & \hspace{-4em} \epsilon_a + \\
    & \hspace{-4em} \epsilon_t
\end{align}
