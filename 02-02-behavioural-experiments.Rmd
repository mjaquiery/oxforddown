...
The procedure for these experiments follows the dates estimation task, described [previously](!TODO). Additionally, in this version, participants had to provide an assessment of the honesty of each advisory estimate they received before they could integrate it into their final decision.
...
There will be a difference in the weight on advice in the probe trials between contexts: WoA will be highest where both trianing advisors have a low-confidence distribution, middling where they have different distributions, and lowest where they both have a high-confidence distribution.
