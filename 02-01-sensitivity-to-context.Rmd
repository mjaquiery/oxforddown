...
For scenarios [1](#models-scenario-1) and [2](#models-scenario-2), which use continuous decisions, this fitness is obtained by subtracting the absolute difference between the final decision and the true value for each decision (mean absolute deviance):
...
[Scenario 3](#models-scenario-3) uses categorical decisions. 
...
The voluminous experiments in advice taking discussed in the [introduction to this section](#context-of-advice) can be seen as eliciting exactly this behaviour.
