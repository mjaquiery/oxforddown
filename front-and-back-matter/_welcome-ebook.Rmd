...
::: {.row}
:::::: {.col-sm-6}
Welcome to the `bs4` output from [my thesis](https://github.com/mjaquiery/oxforddown), based on Ulrik Lyngs' [`oxforddown`](https://github.com/ulyngs/oxforddown) thesis template for [R Markdown](https://rmarkdown.rstudio.com). 
