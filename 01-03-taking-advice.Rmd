...
<!-- Some kind of introduction to this section about how and why we go back to looking at influence rather than advisor choice.
More sensitive?
Closer replication?
-->
...
The study reported here is a preregistered replication of a pilot study which produced the same results.
...
Intuitively, we expect the initial estimate to be the participant's "best guess" for the correct answer, and thus the closer the advice is to this guess (i.e.
the stronger the agreement), the more likely that advice is to be correct.
