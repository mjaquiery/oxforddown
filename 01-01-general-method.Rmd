...
These boxes were briefly and simultaneously filled with an array of non-overlapping dots, and the participant was instructed to identify the box with the most dots.
...
* Off-brand advice in some trials
...
* Anchor date from a roughly normal distribution with SD 8 around the correct answer, clamped to within [1900, 2000]. 

* Advisor position apparently not counterbalanced!?
