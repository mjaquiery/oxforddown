...
```{r m-participant-experience, fig.align='center', fig.cap="Participant pathway through the studies. Participants used their own devices to complete the study, which was presented on a website written in HTML, CSS, and JavaScript. The data were saved on the server using PHP.", out.width="100%"}
...
```{r m-dots, fig.align='center', fig.cap="Dots Task stimulus.", out.width="100%"}
...
```{r m-dates, fig.align='center', fig.cap="Dates Task with continuous responses.", out.width="100%"}
...
```{r m-dates-binary, fig.align='center', fig.cap="Dates Task with binary responses.", out.width="100%"}
