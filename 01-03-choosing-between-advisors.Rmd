...
Mostly we run dots tasks for similarity with Niccolo's stuff, but for the accuracy vs agreement we run dots + dates because we want to show that this 'summary finding' is valid for both tasks.

## Advisor accuracy {#ac-acc}

### Method {#ac-acc-m}

### Result {#ac-acc-r}

#### Dots Task {#ac-acc-r-dots}
