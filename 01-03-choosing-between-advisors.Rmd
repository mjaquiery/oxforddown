...
## Experiment 1: Metacognitive-contingent advisers (Lab) {#ex1}
...
The study was preregistered using AsPredicted.org. The preregistration document can be found at [https://aspredicted.org/ze3tn.pdf](https://aspredicted.org/ze3tn.pdf). The analyses are presented following the structure of the preregistered document where possible. All preregistered analyses are reported, and marked with the preregistration+ symbol: \prereg{} 

The preregistration+ symbol was developed by the Center for Open Science to increase visibility of open scholarship practices in journal articles, and the symbol is used in this thesis according to the rules given by the Centre (https://osf.io/tvyxz/wiki/1.%20View%20the%20Badges/).

Where analyses do not form part of the preregistration, they are reported after the preregistered analyses, or are clearly designated as exploratory in the text.
...
##### \prereg{} Advisor selection on medium-confidence trials
...
#### \prereg{} Advisor influence {#ex1-influence}
...
##### \prereg{} Advisor influence on medium confidence trials
...
#### \prereg{} Subjective assessment of advisers
...
## Experiment 2: Metacognitive-contingent advisers {#ex2}
