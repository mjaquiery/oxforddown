...
kable(tmp, caption = "Table \\label{tab:ac-acc-dots-m-profiles}: Advisor advice profiles for Dots task Accuracy experiment") %>%
  kable_styling() %>%
...
tmp <- tribble(
  ...
  "Low accuracy", agr[1, 2], agr[2, 2], agr[2, 1]
) %>% 
  prop2str()

kable(tmp, caption = "Table \\label{tab:ac-acc-dates-m-profiles}: Advisor advice profiles for Dates task Accuracy experiment") %>%
  kable_styling() %>%
  column_spec(1, bold = T) %>%
  row_spec(0, bold = F) %>%
  collapse_rows(columns = 1, valign = "top") %>%
...
kable(tmp, caption = "Table \\label{tab:ac-agr-dates-m-profiles}: Advisor advice profiles for Dates task Agreement experiment") %>%
  kable_styling() %>%
  column_spec(1, bold = T) %>%
  row_spec(0, bold = F) %>%
  collapse_rows(columns = 1, valign = "top") %>%
...
kable(tmp, caption = "Table \\label{tab:ac-ava-dots-m-profiles}: Advisor advice profiles for Dots task Accuracy/agreement experiment") %>%
  kable_styling() %>%
  column_spec(1, bold = T) %>%
  row_spec(0, bold = F) %>%
  collapse_rows(columns = 1, valign = "top") %>%
