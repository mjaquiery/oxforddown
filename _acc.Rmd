...
gg$acc + gg$conf + gg$roc + gg$auroc + gg$inf +
  plot_layout(
    ncol = 2, 
    nrow = 3, 
    heights = c(.75, .75, 1),
...
As shown by Figure \@ref(fig:ac-acc-dots-r-performance)C, almost all participants showed above-chance metacognitive sensitivity for initial estimates and final decisions.
...
There was no evidence of participants' metacognitive sensitivity being correlated with their task performance (Figure \@ref(fig:ac-acc-dots-r-performance)D). 
...
This difference did not appear to be different between advisors (`r s$s[1]`), and as shown in Figure \@ref(fig:ac-acc-dots-r-performance)E, however, the level of influence was equivalent between advisors, with most participants being almost exactly equally influenced by both advisors (`r s$s[3]`).
...
Estimates of the participants' metacognitive abilities were highly variable, with many participants displaying below-chance metacognitive ability (Figure \@ref(fig:ac-acc-dates-r-performance)C).
...
The correlation between performance on the underlying task and metacognitive ability (Figure \@ref(fig:ac-acc-dates-r-performance)D) shows that, as one might expect, participants with a greater ability to perform the Dates task have a greater insight into their performance on the Dates task.
...
An inspection of the individual participants' data shows that very few participants had large influence differences between advisors (Figure \@ref(fig:ac-acc-dates-r-performance)E).
