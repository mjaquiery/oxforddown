...
\mccorrect{TODO: ANOVA stats for the Advisor/Correct factors on Increased confidence}
...
Participants receiving disagreeing advice occasionally change their mind (much less than they would if they were to average their initial opinion and advice, see the chapter on Context of Advice§\@ref(chapter-context)).
As shown in Figure \@ref(fig:ac-acc-dots-r-performance)E, however, the level of influence was equivalent between advisors, with most participants being almost exactly equally influenced by both advisors.
