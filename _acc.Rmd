...
The extent and manner of decision and confidence changes from before to after advice is an important indicator of the extent to which participants treat the advice as informative (Figure \@ref(fig:ac-acc-dots-r-influence)).
...
This experiment was preregistered at `r unique(datestask$preregistration)`.
