...
This experiment \mccorrect{NICK:provided a basic exploration of advice seeking and advice use in the Dates Task (if it's the first one reported), and aimed to replicate the results of Experiment X in the context of this task. For the reader, a brief orientation sentence or two is helpful, even if it seems redundant.}
