...
use-biblatex: true
bib-latex-options: "style=authoryear, sorting=nyt, backend=biber, useprefix, doi=true, isbn=false, uniquename=true" #for science, you might want style=numeric-comp, sorting=none for numerical in-text citation with references in order of appearance
