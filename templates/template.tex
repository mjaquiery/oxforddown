...
% Modified by Matt Jaquiery (matt.jaquiery@psy.ox.ac.uk), 2020/1
%
...
% MJ allow urls to break on / %
\hypersetup{breaklinks=true}
\def\UrlBreaks{\do\/\do\0\do\1\do\2\do\3\do\4\do\5\do\6\do\7\do\8\do\9}
