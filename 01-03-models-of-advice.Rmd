...
The fitness function for this algorithm assessed the combined error of the model in predicting the participant's advisor selection and advice-taking behavioural data.
...
#' coefficients we estimated within vs between participants.
